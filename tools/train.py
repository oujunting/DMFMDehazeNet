...
import time
import sys
sys.path.append("/data2/zhangzifan/code_dir/2023-11-10-01/")
import mmcv
import torch
...
def parse_args():
    ...
    parser.add_argument('config', default="/data2/zhangzifan/code_dir/2023-11-10-01/my_config/cyclegan.py", help='train config file path')
...
def main():
    ...
    if cfg.model.generator.att and cfg.model.render:
        val_tag = 6.1
    elif cfg.model.generator.att or cfg.model.render:
        val_tag = 5.2
    else:
        val_tag = 3.8
    cfg.data.train['Voxel_Y'] = val_tag
    cfg.data.val['Voxel_Y'] = val_tag
    cfg.data.test['Voxel_Y'] = val_tag
